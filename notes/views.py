...
def signup1(request):
    ...
    if request.method == 'POST':
        ...
        r = request.POST['role']
        try:
            user = User.objects.create_user(username=e, email=e, password=p, first_name=f, last_name=l)
...
def upload_notes(request):
    ...
    if request.method == 'POST':
        ...
        try:
            Notes.objects.create_user(user=u, uploadingdate=date.today(),
                                      branch=b, subject=s, notesfile=n, filetype=f,
